...
class CreateCovid19DB:
    def create_time_series(self):
        ...
        #vaccine:欄位調整
        vaccine["Province_State"] = vaccine["Province_State"].astype(object) #float轉object
        vaccine["Date"] = pd.to_datetime(vaccine["Date"]) #object轉datetime
